...
async function main() {
  ...
  const customerData = [
    ...
    { name: 'Lebrons James', address: null, identityCard: `TEMP-${Date.now()}-1`, type: 2 },
    { name: 'Ishow Speed', address: null, identityCard: `TEMP-${Date.now()}-2`, type: 2 },
    { name: 'Leo Messi', address: null, identityCard: `TEMP-${Date.now()}-3`, type: 2 },
    { name: 'Cristiano Ronaldo', address: null, identityCard: `TEMP-${Date.now()}-4`, type: 2 },
  ];
