...
const CustomerTypes = () => {
  ...
  useEffect(() => {
    const fetchCustomerTypes = async () => {
      ...
      // Normalize fields from Prisma camelCase to PascalCase
      const normalizedData = (data || []).map((ct) => ({
        Type: ct.Type ?? ct.type,
        Name: ct.Name ?? ct.name,
        Coefficient: ct.Coefficient ?? ct.coefficient,
      }));
      setCustomerTypes(normalizedData);
    };
